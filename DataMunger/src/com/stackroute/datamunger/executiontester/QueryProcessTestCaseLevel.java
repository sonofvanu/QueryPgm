package com.stackroute.datamunger.executiontester;
...
{
	static QueryEligibilityQualifier query;

	@BeforeClass
	public static void initialize()
	{
		query=new QueryEligibilityQualifier();
	}
	...
	public void selectAllWithoutWhereTestCase()throws Exception //Test Case 1
	{
		...
		DataCarrier dataSet=query.executeQuery("select * from E:/Emp.csv");
	...
	public void selectColumnsWithoutWhereTestCase()throws Exception //Test Case 2
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv");
		assertNotNull(dataSet);
	...
	public void withWhereGreaterThanTestCase()throws Exception //Test Case 3
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv where salary>30000");
		assertNotNull(dataSet);
	...
	public void withWhereLessThanTestCase()throws Exception //Test Case 4
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv where Salary<35000");
		assertNotNull(dataSet);
	...
	public void withWhereEqualAndNotEqualTestCase()throws Exception //Test Case 8
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv where Salary>=30000 and Salary<=38000");
		assertNotNull(dataSet);
	...
	public void selectCountColumnsWithoutWhereTestCase()throws Exception //Test Case 9
	{
		...
		DataCarrier dataSet=query.executeQuery("select count(Name) from E:/Emp.csv");
		assertNotNull(dataSet);
	...
	public void selectSumColumnsWithoutWhereTestCase()throws Exception //Test Case 10
	{
		...
		DataCarrier dataSet=query.executeQuery("select sum(Salary) from E:/Emp.csv");
		assertNotNull(dataSet);
	...
	public void selectSumColumnsWithWhereTestCase()throws Exception //Test Case 11
	{
		...
		DataCarrier dataSet=query.executeQuery("select sum(Salary) from E:/Emp.csv where City=Bangalore");
		assertNotNull(dataSet);
	...
	public void selectColumnsWithoutWhereWithOrderByTestCase()throws Exception //Test Case 12
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv order by Salary");
		assertNotNull(dataSet);
	...
	public void selectColumnsWithWhereWithOrderByTestCase()throws Exception //Test Case 13
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,Name,Salary from E:/Emp.csv where City=Bangalore order by Salary");
		assertNotNull(dataSet);
	...
	public void selectColumnsWithoutWhereWithGroupByCountTestCase()throws Exception //Test Case 14
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,count(*) from E:/Emp.csv group by City");
		assertNotNull(dataSet);
	...
	public void selectColumnsWithoutWhereWithGroupBySumTestCase()throws Exception //Test Case 15
	{
		...
		DataCarrier dataSet=query.executeQuery("select City,sum(Salary) from E:/Emp.csv group by City");
		assertNotNull(dataSet);
		displayGroupByRecords("selectColumnsWithoutWhereWithOrderByTestCase",dataSet);
