...
public class QueryParseContainer 
{
	private String filePath;
	private String orderByColumn,groupByColumn;
	private SpecifiedColumns columNames;
	...
	public QueryParseContainer(String queryString)throws Exception
	{
		
		columNames=new SpecifiedColumns();
		restrictions=new ArrayList<WhereRestrictionalConditions>();
	...
	public QueryParseContainer parseQuery(String queryString)
	{
