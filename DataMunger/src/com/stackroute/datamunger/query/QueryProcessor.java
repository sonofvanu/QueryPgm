...
{
	QueryParseContainer queryParam;
	
	public QueryProcessor(QueryParseContainer queryParam)
	{
		this.queryParam=queryParam;
	}
	
	//selecting for particular columns
	public DataCarrier getDataSetSimpleQuery()throws Exception
	{
	...
	public LinkedHashMap<String,Float> evaluateAggregateColumns(List<RowDataHolder> groupRows,QueryParseContainer queryParam)
	{
	...
	private boolean evaluateWhereCondition(QueryParseContainer queryParam,String rowValues[])
	{
		List<WhereRestrictionalConditions> listRelationalExpression=queryParam.getListrelexpr();
		HeaderRowData headerRow=queryParam.getHeaderRow();
	...
	private boolean evaluateEachCondition(WhereRestrictionalConditions condition,String rowValues[],HeaderRowData headerRow)
	{
