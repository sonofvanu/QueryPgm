...
//	}
	...
	public void selectColumnsWithoutWhereTestCase(){
		queryparser.inputQuerryArray("select empid,empdept,empname from employee.csv");
	...
	public void withWhereGreaterThanTestCase(){
		queryparser.inputQuerryArray("select empid,empdept,empname from employee.csv where empsalary>30000");
	...
	private void display(String string, Map<Integer, String> dataSet) {
