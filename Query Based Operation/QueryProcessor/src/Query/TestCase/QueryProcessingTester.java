...
public class QueryProcessingTester {
	...
	public void queryInsertionTest() {
		...
		assertNull(queryparser.inputQuerryArray().length);
	...
	public void fetchingrowdata() throws Exception {
		...
		for (String string : filehandler.fetchingRowData(queryparser.filepath)) {
			System.out.println(string);
		}
		assertNotNull(filehandler.fetchingRowData(queryparser.filepath));
